...
function initShortQuestion() {
 qstHead[0]="   Aufgaben";
 qstHead[1]="Beispiel:0 - Teil 2  Sie wollen wissen: Regnet es in Deutschland?     www.openair.de   www.dwd.de    Aufgabe 6  Sie möchten mit dem Schiff auf dem Rhein fahren.   ";
 qstHead[2]="Aufgabe 8  Sie möchten ein Zugticket im Internet kaufen.   ";
 qstHead[3]="Aufgabe 9  Sie möchten Informationen über den Bodensee.   ";
 qstHead[4]="Aufgabe 10  Sie sind in Wiesbaden und möchten mit dem Zug am Mittag in Hamburg sein.   ";
 qstHead[5]="Aufgabe 7  Sie möchten Deutsch in Deutschland lernen.   ";
