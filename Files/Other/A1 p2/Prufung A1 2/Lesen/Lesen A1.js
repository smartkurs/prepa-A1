...
var qstHead;
var groups;
var quizTitle="Lesen A1 deutsch pour tous et tous pour deutsch";
var printCpRg=1;
var filename = 'Lesen A1';
...
function initShortQuestion() {
 qstHead[0]="Beispiel  0 Renate ist nächste Woche in Weimar.  Richtig    Flasch   ";
 qstHead[1]="0 Sie wollen wissen: Regnet es in Deutschland?      6 Sie studieren in Frankfurt und möchten eine Wohnung mieten.  ";
 qstHead[2]="7 Sie möchten wissen: Wie kommt man vom Hamburger Bahnhof zum Hamburger Flughafen? .   ";
 qstHead[3]="8 Sie suchen ein Angebot für Ihre Urlaubsreise  ";
 qstHead[4]="9 Sie suchen eine Wohnung für Ihren Urlaub.   ";
 qstHead[5]="10 Sie arbeiten in Deutschland. In Ihrer Freizeit möchten Sie Fußball spielen.    ";
 qstHead[6]="Beispiel 0 - Teil 3  An der Tür der Sprachschule    Zum Deutsch Lernen gehen Sie in die Beethovenstraße 23.   Richtig.     Falsch.";
}
...
function Constructor() {
  valid = new init_array(0,0,0,0,0,0,0);
  nScore = new init_array(0,0,0,0,0,0,0);
  maxScore = new init_array(0,0,0,0,0,0,0);
  qstHead = new init_array("","","","","","","");
  qstRem = new init_array("","","","","","","");
  initShortQuestion();
  initQuestionRemark();
  groups = new init_array(0,0,0,0,0,0,0);
  pesi = new init_array(0,0,0,0,0,0,0);
  allAnsReport = new init_array(7);
  ordineDomande = new init_array(0,1,2,3,4,5,6);
  typeOfQuest = new init_array(2,1,1,1,1,1,2);
  isQuestCustom = new init_array(0,0,0,0,0,0,0);
  omitPoint = new init_array(0,0,0,0,0,0,0);
}
