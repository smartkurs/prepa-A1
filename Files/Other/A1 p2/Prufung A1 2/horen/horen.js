...
function initShortQuestion() {
 qstHead[0]="  Beispiel  Welche Zimmernummer hat Herr Schneider?  C. Zimmer 254  ist richtig  ";
 qstHead[1]="1 Wo gibt es Kleidung für Kinder? ";
 qstHead[2]="2 Was bestellt die Dame?";
 qstHead[3]="3 Wie lange hat das Museum am Mittwoch geöffnet?";
 qstHead[4]="4 Welchen Sport empfiehlt der Arzt?";
 qstHead[5]="5 Wo macht Familie Bauer Urlaub? ";
 qstHead[6]="6 Wie lange dauert der Flug nach München?";
 qstHead[7]="  Beispiel:     Die Reisende soll zur Information in Halle C kommen.  Richtig     Falsch   ";
 qstHead[8]=" 11 Wann soll Frau Krause anrufen? ";
 qstHead[9]="12 Was möchte Nina heute Abend machen?";
 qstHead[10]="13 Was soll Sarah mitbringen?";
 qstHead[11]="14 Wo wollen sich die Frauen mit Sabine treffen?";
 qstHead[12]="15 Wann will Herr Heinze  Frau Solms treffen?";
}
...
function Constructor() {
  ...
  typeOfQuest = new init_array(1,1,1,1,1,1,1,2,1,1,1,1,1);
