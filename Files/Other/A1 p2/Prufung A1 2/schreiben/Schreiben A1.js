...
var qstHead;
var groups;
var quizTitle="Schreiben A1 deutsch pour tous et tous pour deutsch";
var printCpRg=1;
var filename = 'Schreiben A1';
...
function initShortQuestion() {
 qstHead[0]="Helfen Sie Ihrer Freundin und schreiben Sie die fünf fehlenden Informationen in das Formular. ";
 qstHead[1]="Schreiben Sie zu jedem Punkt ein bis zwei Sätze in das Eingabetextfeld (ca. 30 Wörter). Schreiben Sie auch eine Anrede und einen Gruß.   Beispiel:   ";
}
...
function Constructor() {
  valid = new init_array(0,0);
  nScore = new init_array(0,0);
  maxScore = new init_array(0,0);
  qstHead = new init_array("","");
  qstRem = new init_array("","");
  initShortQuestion();
  initQuestionRemark();
  groups = new init_array(0,0);
  pesi = new init_array(0,0);
  allAnsReport = new init_array(2);
  ordineDomande = new init_array(0,1);
  typeOfQuest = new init_array(4,3);
  isQuestCustom = new init_array(0,0);
  omitPoint = new init_array(0,0);
}
